...
@section('content')
<h1 class="text-2xl font-bold text-gray-800 mb-6">Cancelled Orders</h1>
        ...
        @foreach ($orders as $order)
            <div class="bg-white border rounded shadow p-6">
                <div class="mb-2">
                    ...
                    <p class="text-sm text-gray-600">Cancelled: {{ $order->updated_at->format('F j, Y') }}</p>
                    <p class="font-medium text-red-600">Status: Cancelled</p>
                </div>
